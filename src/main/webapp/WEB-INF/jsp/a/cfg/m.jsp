          ...
          <div class="panel panel-default">
            ...
            <form class="form-horizontal" name="form1" action="/a/cfg/m" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input class="form-control" type="text" id="rocKey" name="rocKey" placeholder="Key"
                         required="required" value="${configVo.rocKey}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input class="form-control" type="text" id="rocValue" name="rocValue" placeholder="Value"
                         required="required" value="${configVo.rocValue}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input type="checkbox" id="permission" name="visible" value="1"
                         <c:if test="${configVo.visible == 1}">checked</c:if>/> Visible <br/>
                  <input type="checkbox" name="operable" value="1"
                         <c:if test="${configVo.operable == 1}">checked</c:if>/> Operable <br/>
                  <input type="checkbox" name="deleted" value="1" <c:if test="${configVo.deleted == 1}">checked</c:if>/>
                  Deleted
                </div>
              </div>
              <div class="form-group">
