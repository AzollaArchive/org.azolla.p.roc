      ...
      <main class="col-md-9">
        <article class="roc-c-article-post">
          ...
          <div class="panel panel-default">
            ...
            <form class="form-horizontal" name="form1" action="/a/t/m" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input class="form-control" type="text" id="displayName" name="displayName" placeholder="DisplayName"
                         required="required" value="${tagVo.displayName}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <input type="checkbox" id="permission" name="visible" value="1"
                         <c:if test="${tagVo.visible == 1}">checked</c:if>/> Visible <br/>
                  <input type="checkbox" name="operable" value="1" <c:if test="${tagVo.operable == 1}">checked</c:if>/>
                  Operable <br/>
                  <input type="checkbox" name="deleted" value="1" <c:if test="${tagVo.deleted == 1}">checked</c:if>/>
                  Deleted
                </div>
              </div>
              <div class="form-group">
