  ...
  (function () {
    ...
    var $ = function () {
      ...
      (function () {
        ...
        var V = window, G = ["break,continue,do,else,for,if,return,while"], J = [[G, "auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"],
