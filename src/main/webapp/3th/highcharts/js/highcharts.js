...
(function () {
  ...
  function Ja(a, b) {
    for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
      ...
      if (d) {
        ...
        if (f.length)f = f.join(":"), g = /\.([0-9])/, h = T.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e
      !==
        null && (e = A.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))
      ):
        e = Oa(f, e)
      }
      j.push(e);
    ...
    Wb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function (a) {
      ...
      return {
        get: function (c) {
          ...
          d ? (f = z(a), f
          .
          stops = [].concat(f.stops), o(d, function (a, b) {
      ...
      if (!b) {
        if (f.namespaceURI === Ca || c.forExport) {
          try {
            ...
            }, La && j.textShadow ? (i = j.textShadow, j
          .
            textShadow = ""
          ):
            k && k(P), b = f.getBBox ? x({}, f.getBBox()) : {
              width: f.offsetWidth,
  ...
  ua.prototype = {
    Element: Q, init: function (a, b, c, d, e) {
      ...
      !f && !n && !v && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S
      &&
      S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
          ...
          if (e !== "" || g.length === 1) {
            ...
            if (e !== " ") {
              ...
              if (l) {
                ...
                (S ? -1 : 1) * ta(C)), n = [z + (l > 3 ? "…" : "")], s.removeChild(s.firstChild))) : !S || n.length === 1 ? (n = u, u = [], n
              .
                length && (r++, s = B.createElementNS(Ca, "tspan"), J(s, {
                  dy: y,
                  x: j
                }), p && J(s, "style", p), b.appendChild(s)), q > l && (l = q)
              ):
                (s.removeChild(s.firstChild), u.unshift(n.pop())), n.length && s.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
  ...
  va.prototype = {
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b ? (a = a * h + i, a-= k, a = a / j + d, e && (a = g.lin2val(a))
      ):
      (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a = h * (a - d) * j + i + h * k + (ra(f) ? j * f * g.pointRange : 0));
      return a
    },
    toPixels: function (a,
                        b) {
  ...
  x(A.Pointer.prototype, {
    pinchTranslate: function (a, b, c, d, e, f) {
      ...
      var c = this.chart;
      pa = c.index;
      a.touches.length === 1 ? (a = this.normalize(a), c
      .
      isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu ? (b && this.runPointActions(a), this.pinch(a)) : b && this.reset()
      ):
  ...
  R.prototype = {
    ...
    animate: function (a) {
      ...
      (a = b[d]) && a.animate({width: b.plotSizeX},
  ...
  R.prototype.setStackedPoints = function () {
    if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
      ...
      &&
        m[o] && m[o][t] ? (o = m[o][t], s
      .
        total = o.total = u(o.total, s.total) + O(w) || 0
      ):
        s.total = ea(s.total + (O(w) || 0))
      ):
        s.total = ea(s.total + (w || 0));
        s.cum = p(s.cum,
          g) + (w || 0);
  ...
  xa = ka(R, {
    type: "spline", getPointSpline: function (a, b, c) {
      ...
      if (f && g) {
        ...
        i += l;
        k += l;
        i > a && i > e ? (i = u(a, e), k = 2 * e - i):i
      <
        a && i < e && (i = C(a, e), k = 2 * e - i);
        k > g && k > e ? (k = u(g, e), i = 2 * e - k):k
      <
        g && k < e && (k = C(g, e), i = 2 * e - k);
        b.rightContX = j;
        b.rightContY = k
      }
      c ? (b = ["C", f.rightContX || f.plotX, f.rightContY || f.plotY, h || d, i || e, d, e], f
      .
      rightContX = f.rightContY = null
      ):
      b = ["M", d, e];
      return b
    }
  ...
  if (M.pie)M.pie.prototype.drawDataLabels = function () {
    ...
    var b = this.center, c = this.options, d = c.center, e = c.minSize ||
      80, f = e, g;
    d[0] !== null ? f = u(b[2] - u(a[1], a[3]), e) : (f = u(b[2] - a[1] - a[3], e), b
    [
    0
    ]
    += (a[3] - a[1]) / 2
    ...
    ;
    d[1] !== null ? f = u(C(f, b[2] - u(a[0], a[2])), e) : (f = u(C(f, b[2] - a[0] - a[2]), e), b
    [
    1
    ]
    += (a[0] - a[2]) / 2
