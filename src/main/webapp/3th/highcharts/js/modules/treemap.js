...
(function (g) {
  ...
  i.treemap = t(i.scatter, m({
    ...
    type: "treemap", trackerGroups: ["group", "dataLabelsGroup"], pointClass: t(g.Point, {
    ...
    calculateChildrenAreas: function (a, b) {
      ...
      if (a !== null)this.drillToNode(a.id), a.id === "" ? this.drillUpButton = this.drillUpButton.destroy() : (a = this.nodeMap[a.parent],
      ...
      this.drillUpButton = this.chart.renderer.button(a, null, null, function () {
        b.drillUp()
    ...
    }, buildKDTree: v, drawLegendSymbol: g.LegendSymbolMixin.drawRectangle, getExtremes: function () {
