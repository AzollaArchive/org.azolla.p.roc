(function (f) {
  ...
  f.SVGRenderer.prototype.Element.prototype.fadeIn =
    function (b) {
      this.attr({opacity: 0.1, visibility: "inherit"}).animate({opacity: u(this.newOpacity, 1)}, b || {duration: 250})
    };
  ...
  m.prototype.showDrillUpButton = function () {
    ...
    this.drillUpButton ? this.drillUpButton.attr({text: a}).align() :
      (g = (d = c.theme) && d.states,
    this.drillUpButton = this.renderer.button(a, null, null, function () {
      b.drillUp()
