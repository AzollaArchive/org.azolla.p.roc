...
(function (k, D) {
  ...
  var G = M.prototype, y = y.prototype, V = {
    ...
    getPlotBandPath: function (a, b, c) {
      ...
      this.options.gridLineInterpolation === "polygon" ? d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)) : (a = Math.max(a, this.min), b = Math.min(b, this.max), m
      ||
      (i[0] = this.translate(a),
  ...
  u(y, "getLabelPosition", function (a, b, c, d, e, f, i, g, l) {
    ...
    2 + q(f.distance, -25)), f
    .
    rotation === "auto" ? d.attr({rotation: A}) : j === null && (j = m.chart.renderer.fontMetrics(d.styles.fontSize).b - d.getBBox().height / 2), h === null && (m.isCircular ? (this.label.getBBox().width > m.len * m.tickInterval / (m.max - m.min) && (n = 0), h = A > n && A < 180 - n ? "left" : A > 180 + n && A < 360 - n ? "right" : "center") : h = "center", d.attr({align: h})), a.x += f.x, a.y += j
    ):
    a = a.call(this, b, c, d, e, f, i, g, l);
    return a
  });
    ...
    translate: function () {
      ...
      t(this.points, function (d) {
        var e = o(b.dial, d.dial), f = x(q(e.radius, 80)) * c[2] / 200, i = x(q(e.baseLength, 70)) * f / 100, g = x(q(e.rearLength, 10)) * f / 100, l = e.baseWidth || 3, m = e.topWidth || 1, j = b.overshoot, n = a.startAngleRad + a.translate(d.y,
            null, null, null, !0);
        j && typeof j === "number" ? (j = j / 180 * Math.PI, n = Math.max(a.startAngleRad - j, Math.min(a.endAngleRad + j, n))):b.wrap
        ===
        !1 && (n = Math.max(a.startAngleRad, Math.min(a.endAngleRad, n)));
        n = n * 180 / Math.PI;
        d.shapeType = "path";
        d.shapeArgs = {
  ...
  (function () {
    ...
    function b(a,
      ...
      .
        ...
        (c = {translateX: h, translateY: k, scaleX: 1, scaleY: 1}, e
      .
        animate(c, d), j && j.animate(c, d), this.animate = null
      )
      } else a.call(this, b)
    }
    ...
    h.spline && u(h.spline.prototype, "getPointSpline", function (a, b, c, d) {
      ...
      if (this.chart.polar) {
        ...
        d ? (c = ["C", a.rightContX || a.plotX, a.rightContY || a.plotY, h || e, k || j, e, j], a
      .
        rightContX = a.rightContY = null
      ):
        c = ["M", e, j]
