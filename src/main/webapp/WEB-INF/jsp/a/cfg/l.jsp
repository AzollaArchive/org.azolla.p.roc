        ...
        <article class="roc-c-article-post">
          <div class="panel panel-default">
            ...
            <div class="panel-heading">
              ${jsp_title} <span class="label label-default"><a href="/a/cfg/m"
                                                                style="color: #FFFFFF;text-shadow: none">ADD</a></span>
            </div>
            <!-- Table -->
                ...
                <c:forEach var="configVo" items="${configVoList}">
                  <tr>
                    ...
                    <td><input type="checkbox" disabled
                               <c:if test="${configVo.visible == 1}">checked="checked"</c:if> /></td>
                    <td><input type="checkbox" disabled
                               <c:if test="${configVo.operable == 1}">checked="checked"</c:if> /></td>
                    <td><input type="checkbox" disabled
                               <c:if test="${configVo.deleted == 1}">checked="checked"</c:if> /></td>
